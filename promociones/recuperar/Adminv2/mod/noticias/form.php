    ...
    <div class="box-body">
      <div class="row form-group">                      
        <div class="col-xs-6">
          ...
          <select class="form-control input-sm required" name="seccion" id="seccion">
        ...
        <div class="col-xs-6">
          ...
          <select class="form-control input-sm required" name="tipo" id="tipo">
            ...
            <option value="EN" <? if($post->charnoticiatipo=="EN"){echo "selected";} ?>>ENTRETENIMIENTO</option>            
                    ...
                    <div class="row form-group">                      
                      <div class="col-xs-12">
                        ...
                        <textarea id="cktitulo" name="cktitulo" data-maxlen="100" class="form-control input-sm textarea-titulo required" placeholder="Titulo"><?=htmlspecialchars_decode(stripcslashes($post->varnoticiatitulo))?></textarea>                        
                      </div>
                    </div>
                    <div class="row form-group">
                      <div class="col-xs-12">
