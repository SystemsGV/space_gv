...
END as tipo ,DATE_FORMAT(dateNoticiaFreg, '%d/%m/%Y %r') fregistro from noticia where charNoticiaGrupo='NO' order by intnoticiaid desc");
?>
                  ...
                  <table id="example1" class="table table-bordered table-hover display" width="100%" data-page-length="25">
                    ...
                    <? foreach($post as $k=>$v){$i++;?>
                      <tr>
                       ...
                       <td><?=$v->fregistro?></td>
                       <td>
                       <span class="label label-success" data-toggle="tooltip" title="<?=$v->seccion?>"><?=$v->charnoticiasec?></span>
                       <span class="label label-primary" data-toggle="tooltip" title="<?=$v->tipo?>"><?=$v->charnoticiatipo?></span>
                       </td>                        
                        <!--<td>
