            ...
            <td width="304" height="361" background="iconos/bg_datos.jpg" valign="top">
                ...
                <td colspan="5" height="50"></td>
              	...
              	<tr>
                <td width="23"></td>
                <td colspan="3" class="txt_verde14" align="left">La Granja Villa y su Mundo Magico<br>tiene grandes beneficios para ti y<br>tus seres queridos.</td>
                <td width="23"></td>
              	</tr>
                <tr>
                ...
                <td width="75"></td>
                <td width="8"></td>
                <td width="175" align="right"><a href="proc_login.php?op=cerrar"><img src="iconos/bt_cerrarsesion.gif" alt="" border="0"></a></td>
                <td width="23"></td>
                </tr>
                </table>
