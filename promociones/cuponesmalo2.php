 ...
 onMouseout="hideddrivetip()" hspace="12" vspace="10" width="185" height="85" alt="" border="0"></a>
			   <? }}?>
                ...
                <td width="220" height="160" valign="top" align="left" class="bg_cupon">
                	...
                	<tr>
                    <td width="12"></td>
                    <td><img src="iconos/bg_cupon_ver.png" width="185" height="85" alt="" border="0"></td>
                    </tr>
                    <tr>
                	...
                	<tr>
                    <td width="12"></td>
                    <td><a href="javascript:ventanaSecundaria('pop_vercupon.php?idcp=<?=$rs["id_fotocupon"]?>')"> <img src="<?=UPLOAD_FOTOS_PUB.$img?>" style="background-image:url(iconos/bg_cupon_ver.png); padding: 10px 13px 47px 10px;></a>
                    </td>
                    </tr>
                    </table>
                </td>
