...
if($_POST[cmd]=="addcart"){
	...
	if($_SESSION[sess_user][idusuario]){
		...
		$datoscuenta .= "Dirección: " . $_POST[dir]."<br>";
		$datoscuenta .= "Usuario: " . $_POST[dnival]."<br>";
		$datoscuenta .= "Contraseña: " . substr($_POST[rpassword],0,-3)."***<br>";
		...
		$body = str_replace($findtxt, $newtxt, $body);
	      ...
	      while ((!$exito) && ($intentos < 2)) {
	       ...
	       if (!$exito){
	           ...
	           $content='<br><div class="text-center">Por favor, verifique su correo para activar su cuenta y poder iniciar sesión</div><br>';
...

{
	...
	if($tipo_pago==2)// Pago con tarjeta VISA
	{
		...
		$arr=array("msg"=>array("tipo"=>"confirm","titulo"=>"Confirmar compra","txtconfirm"=>"Ok","txtcancel"=>"Cancelar","content"=>$content,"urlconfirm"=>"?mod=form-visa","urlcancel"=>""));
	...
	}else
	{
		...
		$cc="lvega12@gmail.com,alex_gil17@hotmail.com";	    
