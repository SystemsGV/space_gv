                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-hover display" width="100%" data-page-length="25">
					...
					foreach($post as $k=>$v){
						...
						$postdet = Orderdet::find_by_sql("SELECT COUNT(intCartId) AS membresia FROM orderdet WHERE intCartId = ".$v->intcartid." AND charCartdetTipo='M'");
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php } ?>
                           ...
                           <!--<button data-href="mod/<?=$_GET[mod]?>/changetip.php?mod=<?=$_GET[mod]?>&act=del&idf=<?=$v->intcartid?>" class="btn btn-default move-cash">
