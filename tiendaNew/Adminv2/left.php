<section class="sidebar"> 
	...
	<?php } ?>   
        <?php if($_SESSION['sess_admin']['tipo']==1 || $_SESSION['sess_admin']['tipo']==2 || $_SESSION['sess_admin']['tipo']==9){ ?>    
        ...
        <?php } ?>
		<?php if($_SESSION['sess_admin']['tipo']==1){ ?>
        <li <?php if($mod=="order"){echo 'class="active"';}?>><a href="?mod=order&page=index"><i class="fa fa-th"></i> <span>ORDER</span></a></li>
        <?php } ?>
        <?php if($_SESSION['sess_admin']['tipo']==1){ ?>
        ...
        <?php } ?>
        <?php if($_SESSION['sess_admin']['tipo']==1 || $_SESSION['sess_admin']['tipo']==9){ ?>
        <li <?php if($mod=="epresencial"){echo 'class="active"';}?>><a href="?mod=epresencial&page=index"><i class="fa fa-ticket"></i> <span>ENTRADAS PRESENCIALES</span></a></li>
        <?php } ?>		
        <?php if($_SESSION['sess_admin']['tipo']==1){ ?>
