            ...
            <div class="col-md-12">         
                <ul class="nav navbar-topall navbar-nav navbar-right">
                    <li style="background:#f6f6f6;">
                        <a href="http://lagranjavilla.com/tiendaNew/" style="color:#3b1a04;">
                            <i class="fa fa-ticket"></i> COMPRAR ENTRADAS
                        </a>
                    </li>
                    <li>
                        <a href="?mod=list"><i class="fa fa-shopping-cart"></i> <span class="cart-items"><?=count($_SESSION["sess_cart"])?></span> - tickets</a>
                    </li>
                    <?php
                                        ...
                                        <div class="col-md-12">
                                            <form class="formAll" role="form" name="frmLogin" id="frmLogin" action="prc.php" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="dni" placeholder="DNI" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" maxlength="15" data-fv-regexp-message="Porfavor ingrese un valor correcto.">
                                                </div>
                                                <div class="form-group">
