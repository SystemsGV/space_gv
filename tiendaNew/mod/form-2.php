...
$post = Tarjeta::find_by_sql("select nTarjNumb,DATE_FORMAT(dEmisDate,'%d/%m/%Y') inidate,DATE_FORMAT(dCaduDate,'%d/%m/%Y') findate,DATEDIFF(dCaduDate,now()) as fdias from TARJETA where ccliecode='{$_SESSION["sess_user"]["idusuario"]}'");
?>
                ...
                <div class="modal-body">
                    <div class="row">
                                ...
                                <form class="formAll" role="form" name="frmSelTicket" id="frmSelTicket" action="prc.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control required" name="dni" placeholder="DNI"  autocomplete="off"  data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" maxlength="15" data-fv-regexp-message="Porfavor ingrese un valor correcto.">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control required" name="password" placeholder="Password" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio">
                                        </div>
                                        <span class="help-block"></span>
                                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled" style="line-height: 2"></ul>
                        ...
                        <div class="box">
                            <div class="box-body no-padding">
                                <table class="table table-condensed">
                                    ...
                                    <?php foreach($_SESSION["sess_cart"] as $key => $value) {$i++;$stotal = $stotal + $value["txttotal"];?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        ...
                                        <td>S/.<?php echo number_format($value["txttotal"], 2,'.','')?></td>
                                    </tr>
                                    <?php } ?>
                              </table>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-sm"  name="rsocial" placeholder="Razón Social" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" data-fv-stringlength="true" data-fv-stringlength-min="3" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-sm" name="ruc" placeholder="RUC" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" data-fv-regexp="true" data-fv-regexp-regexp="^[0-9_\.]+$" maxlength="11" data-fv-regexp-message="Porfavor ingrese un valor correcto.">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-sm" name="dir" placeholder="Dirección" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" data-fv-stringlength="true" data-fv-stringlength-min="2" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-heading" >
                                <div class="row display-tr" >
                                    <h3 class="panel-title display-td" >
                                        <img class="img-responsive pull-left" src="img/accepted_c22e0.jpg">&nbsp;&nbsp;&nbsp;<strong>Pago con VISA</strong>
                                    </h3>
