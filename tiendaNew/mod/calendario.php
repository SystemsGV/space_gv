...
<div class="container module-opt" id="content-mod-center">
    <div class="row container">
        <div class="col-md-7 module-info">        
            ...
            <p id="seguro2" class="text-justify" align="justify" style="font-size:14px; "><b>SISTEMA INTELIGENTE DENTRO DEL PARQUE DURANTE TODO EL DIA, DE 10AM A 6PM: </b></p>
            <p id="seguro4" class="text-justify" align="justify" style="font-size:14px; ">¡Nos renovamos y te traemos la mejor tecnología sin contacto! Conoce to-dos los beneficios de los dispositivos inteligentes, 
             cómpralos solo una vez y recárgalos para todas tus futuras visitas. El dispositivo inteligente es in-transferible, personal e indispensable para poder ingresar al parque y dis-frutar de las atracciones.
             Permite que puedas agregar saldo y adquirir lo que desees en todos los puntos de venta del parque. Podrá ser, también, la llave digital para el alquiler de locker si así lo deseas. Además, tendrás tu historial de acceso a juegos y compras.
             El costo del dispositivo inteligente es aparte del precio de entradas y de-más servicios que se ofrecen dentro del parque.</p>
        </div>
        <div class="col-md-5 module-info"><br>
            <h4><?=strip_tags(htmlspecialchars_decode(stripcslashes($post->varboletotitulo)))?></h4><hr>
            <? 
            if($post->varboletoimg) {
                if(file_exists("Adminv2/uploads/{$post->varboletoimg}")) {
            ?>
                    ...
                    <div class="box-body">
                        <div class="box box-danger">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <label style="margin-top :6px">Dispositivos</label>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <select id="cb_accesorios" class="form-control" style="width:100%;">
                                                    <option value="Seleccione">Seleccione</option>
                                                    <option value="Tarjeta">Tarjeta</option>
                                                    <option value="Portatarjeta">Tarjeta + langer</option>
                                                  <!--  <option value="Pulsera">Pulsera ajustable</option>-->
                                                    <option value="Pulserasilicona">Pulsera silicona</option>
                                                    <option value="Pulserafashion">Pulsera silicona ajustable</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <span class="input-group-addon">S/.</span>
                                                <input type="text" class="form-control input-sm" readonly name="txt_acc" id="txt_acc" value="0" readonly>
                                            </div>                        
                                        </div>
                                    </div>  
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <!-- <label>Total:</label> -->
                                            <div class="input-group">
                                                <!-- <span class="input-group-addon">S/.<i class="fa fa-calendar"></i></span> -->
                                                <input type="hidden" class="form-control input-sm" readonly name="txttotal" id="txttotal">
                                            </div>
                                        </div>
                                    </div>
