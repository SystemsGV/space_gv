    ...
    <div class="row container">
      ...
      <?php } ?>
     	 <div class="caption text-center">
            <h3 style="font-family: 'riffic_freebold', sans-serif; letter-spacing: 1.5px; color: #000000;"><?=strip_tags(htmlspecialchars_decode(stripcslashes($v->varboletonombre)))?></h3>            
          </div>      
        <div class="thumbnail" align="center">
        <? if($v->varboletoicon){if(file_exists("Adminv2/uploads/{$v->varboletoicon}")){?>              
          <a href="?mod=calendario&sel=<?=$v->intboletoid?>"><img src="<?="Adminv2/uploads/{$v->varboletoicon}"?>" style="border: 6px solid #0e7205;" class="opt<?=$v->intboletoid?>"></a>
        <? }}?>
          <div class="caption text-center">         
      ...
      <? }?>
        ...
        <div class="col-md-4 col-md-offset-1">
	         	 <div class="caption text-center">
            <h3 style="font-family: 'riffic_freebold', sans-serif; letter-spacing: 1.5px; color: #000000;">Festival del Terror</h3>
          </div>      
        <div class="thumbnail" align="center">-->
                      
         <!--<a data-toggle="modal" data-target="#TerrorModal"><a><img src="Adminv2/uploads/0962831001526570662.jpeg" style="border: 6px solid #0e7205;"></a>
                  <div class="caption text-center"> -->        
            <!--<a disabled class="btn btn-danger" style="font-size:18px;" role="button" data-toggle="modal" data-target="#TerrorModal"><strong>COMPRAR ENTRADAS</strong></a>-->
             <!--<a  disabled class="btn btn-danger" href="?mod=calendario&sel=11" style="font-size:18px;" role="button"><strong>COMPRAR ENTRADAS</strong></a>-->
          </div>
        </div>
      </div> 	  
    </div>
