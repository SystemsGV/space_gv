...
function guarda()
{
	$sql="insert tbl_noticia_tc(txt_titulo,txt_fecha,txt_resumen,txt_descripcion,txt_foto,int_estado) values('".
		urlencode($this->get_txt_titulo())."','".
		urlencode($this->get_txt_fecha())."','".
		urlencode($this->get_txt_resumen())."','".
		urlencode($this->get_txt_descripcion())."','".
		urlencode($this->get_txt_foto())."','".
		$this->get_int_estado()."');";
		conn_ejecuta($sql); 
}
...
function actualiza()
{
	$sql="update tbl_noticia_tc set txt_titulo='".urlencode($this->get_txt_titulo())."', 
			txt_fecha='".urlencode($this->get_txt_fecha())."', 
			txt_resumen='".urlencode($this->get_txt_resumen())."',
			txt_descripcion='".urlencode($this->get_txt_descripcion())."', 
			txt_foto='".urlencode($this->get_txt_foto())."', 
