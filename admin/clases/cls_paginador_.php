...
//*****************************FIN DE PAGINACION POR GRUPOS
	...
	{
				echo   "<table width='251' border='0' align='center' cellpadding='1' cellspacing='0'>";
				echo   "<tr>"; 

		  			if($bloque_actual>1)
					{
						echo    "<td align='right' width='100'  class='".$this->estilos_pag[2]."'>";					
				...
				echo   "<td align='right'><span class='txt_gris10'>P&aacute;g.&nbsp;</span>";
				...
				echo	"     &nbsp;</td>";				
					...
					{
					echo    "<td align='left' width='100'  class='".$this->estilos_pag[2]."' >&nbsp;&nbsp;";					
