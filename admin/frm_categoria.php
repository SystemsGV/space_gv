...
//	include("fckeditor/fckeditor.php") ;
	...
	$enoteca_modulos = new cls_emp_categoria($id_modulos);	
?>
...
function editar(id)
{
	...
	if(i==0){
		...
		document.form1.action="proc_categoria.php?op=2&id="+id;
  ...
  <td width="908">
	...
	<td>
		...
		<td width="881" height="4"><table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			<td height="30" bgcolor="#DEDAC8" class="titus">&nbsp;&nbsp;EL CATALOGO - CATEGORIAS</td>
			<td height="30" bgcolor="#DEDAC8" align="right" valign="bottom"><a href="inf_categoria.php"><img src="iconos/volver.gif" alt="Volver" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		  </tr>
		  <tr>
			<td height="10"></td>
		  </tr>
          ...
          <table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
            <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
              ...
              <tr bgcolor="#F9F6ED">
                <td height="5"></td>
                <td></td>
                <td width="549" align="left" bgcolor="#F9F6ED"></td>
              </tr>
              <tr bgcolor="#F9F6ED">
                <td width="322" height="25" align="right" bgcolor="#F9F6ED"><span class="titus_tablas">Nombre de Categor&iacute;a</span></td>
                <td width="10">:</td>
                <td align="left"><input name="txt_titulo" type="text" class="input" size="40" style="width:280px;" value="<?=$enoteca_modulos->get_txt_nombre()?>" /></td>
              </tr>
			  <tr bgcolor="#F9F6ED">
                <td height="26" align="right" class="titus_tablas">Curso de Facultad</td>
                <td>:</td>
                <td align="left" bgcolor="#F9F6ED"><select name="txt_cursofacultad" class="select">
                    <option value="0" <? if($enoteca_modulos->get_txt_cursofacultad()==0){ echo "selected"; }?> ><? echo NO?></option>
                    <option value="1" <? if($enoteca_modulos->get_txt_cursofacultad()==1){ echo "selected"; }?> ><? echo SI?></option>
                  </select>                </td>
              </tr>
              <tr bgcolor="#F9F6ED">
