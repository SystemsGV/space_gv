...
function eliminar(id, img)
{
	...
	if (entrar)
	{   
		location.href="proc_usuarios.php?op=3&id=" + id + "&img=" + img;
	}
}
</script>
</head>
			...
			<table width="881" border="0" cellpadding="0" cellspacing="0" align="center">
			  <tr>
				<td width="881" height="4"><table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					<td height="30" bgcolor="#F1EEE7" class="titus">&nbsp;&nbsp;MODULO USUARIOS</td>
				  </tr>
				  <tr>
					<td height="10"></td>
				  </tr>
				...
				<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  ...
					  <td width="300" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">Usuarios</td>
					  <td width="100" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">User</td>
					  <td width="100" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">E-mail</td>
					  <td width="100" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">Tipo Cup&oacute;n</td>	 
					...
					<?
						$sql="select id_usuarios from tbl_usuarios order by  id_usuarios DESC";
					...
					//	echo "paginador->pos_final_pag : ".$paginador->pos_final_pag;
						while($contador < $paginador->pos_final_pag)
						{
								...
								if(!empty($registro[0]))
								{
									$usuarios= new cls_emp_usuarios($registro[0]);
									if($color=="#F2F0EB")
									{
									  $color="#F6F5F5";}
									else{
					...
					<tr valign="middle" bgcolor="<? echo $color?>">
					  ...
					  <td align="left" bgcolor="<? echo $color?>" class="texto_02"><?=urldecode($usuarios->get_txt_apellido())?>, <?=urldecode($usuarios->get_txt_nombre())?></td>
					  <td align="left" bgcolor="<? echo $color?>" class="texto_02"><?=urldecode($usuarios->get_txt_usuario())?></td>
					  <td align="left" bgcolor="<? echo $color?>" class="texto_02"><?=urldecode($usuarios->get_txt_email())?></td>
					  <td align="left" bgcolor="<? echo $color?>" class="texto_02"><?=inc_devuelve_tipocupon($usuarios->get_id_opc())?></td>
					  <td align="center"><a href="frm_usuarios.php?id=<? echo $usuarios->get_id_usuarios()?>"><img src="iconos/icon18_editdoc.gif" border="0" alt="Editar registro" title="Editar registro" /></a>&nbsp;&nbsp; <a href="javascript:eliminar('<? echo $usuarios->get_id_usuarios()?>','<? echo $foto?>')"><img src="iconos/delete.gif" border="0" alt="Eliminar registro" title="Eliminar registro" /></a></td>
					</tr>
					<?
					}
					$contador++;
					...
					<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td width="205" align="left"><a href="frm_usuarios.php"><img src="iconos/ico_nuevo.gif" border="0" alt="Agregar nuevo"></a></td>
