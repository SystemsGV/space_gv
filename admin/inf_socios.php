			...
			<table width="881" border="0" cellpadding="0" cellspacing="0" align="center">
			  <tr>
				<td width="881" height="4"><table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					<td height="30" bgcolor="#F1EEE7" class="titus">&nbsp;&nbsp;REGISTROS DE SOCIOS</td>
				  </tr>
				  <tr>
					<td height="10"></td>
				  </tr>
				...
				<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  ...
					  <td width="205" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">Nombre</td>
					  <td width="166" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">E-mail</td>
					  <td width="124" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">Usuario</td>
					...
					<?
						$sql="select id_socio from tbl_socio";
					...
					//	echo "paginador->pos_final_pag : ".$paginador->pos_final_pag;
						while($contador < $paginador->pos_final_pag)
						{
								...
								if(!empty($registro[0]))
								{
									$socio= new cls_emp_socio($registro[0]);
									if($color=="#F2F0EB")
									{
									  $color="#F6F5F5";}
									else{
					...
					<tr valign="middle" bgcolor="<? echo $color?>">
					  ...
					  <td align="left" bgcolor="<? echo $color?>" class="texto_02"><? echo $socio->get_txt_nombres()?></td>
					  <td align="left" bgcolor="<? echo $color?>" class="texto_02"><? echo $socio->get_txt_email()?></td>
					  <td align="left" bgcolor="<? echo $color?>" class="texto_02"><? echo $socio->get_txt_usuario()?></td>
					  <td align="left"><a href="frm_socios.php?id=<? echo $socio->get_id_socio()?>"><img src="iconos/icon18_editdoc.gif" border="0" alt="Editar registro" title="Editar registro" /></a>&nbsp;&nbsp; <a href="javascript:eliminar(<? echo $socio->get_id_socio()?>)"><img src="iconos/delete.gif" border="0" alt="Eliminar registro" title="Eliminar registro" /></a> </td>
					</tr>
					<?
					}
					$contador++;
					...
					<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						<td width="205" align="left"><!--<a href="frm_socios.php"><img src="iconos/ico_nuevo.gif" border="0" alt="Agregar nuevo"></a>--></td>
