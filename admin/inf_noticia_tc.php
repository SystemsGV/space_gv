			...
			<table width="881" border="0" cellpadding="0" cellspacing="0" align="center">
			  <tr>
				<td width="881" height="4"><table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					<td height="30" bgcolor="#F1EEE7" class="titus">&nbsp;&nbsp;MODULO NOTICIAS Y ARTICULOS- ZONA ECOL&oacute;ICA</td>
				  </tr>
				  <tr>
					<td height="10"></td>
				  </tr>
				...
				<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  ...
					  <td width="220" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">Titulo</td>
					...
					<tr valign="middle" bgcolor="<? echo $color?>">
					  ...
					  <td align="center"><a href="frm_noticia_tc.php?id=<? echo $noticia_tc->get_id_noticia_tc()?>"><img src="iconos/icon18_editdoc.gif" border="0" alt="Editar registro" title="Editar registro" /></a>&nbsp;&nbsp; <a href="javascript:eliminar('<? echo $noticia_tc->get_id_noticia_tc()?>','<? echo $foto?>')"><img src="iconos/delete.gif" border="0" alt="Eliminar registro" title="Eliminar registro" /></a></td>
					</tr>
					<?
					}
					$contador++;
