...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	?>
        ...
        <link rel="stylesheet" href="css/data-tables/DT_bootstrap.css" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="emailrecovery" id="emailrecovery" placeholder="Email" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" data-fv-emailaddress="true" data-fv-emailaddress-message="Porfavor ingrese un valor correcto.">
                                    </div>
	...
	<?php if($mod=="entradas"){ ?>
		...
		<script>
            ...
            editor = new $.fn.dataTable.Editor({
        		ajax: "mod/funciones/table_entradas.php",
        		table: "#example",
        		fields: [
        		    { label: "Nombres:", name: "varCartdetNombres" },
        		    { label: "Apellido Paterno:", name: "varCartdetApepat" },
        		    { label: "Apellido Materno:", name: "varCartdetApemat" },
        		    { label: "DNI:", name: "charCartdetDni"	},
        		    { label: "Teléfono:", name: "varCartdetTelefono" }
        		],
        		i18n: {
                    edit:   { button: "Editar",   title: "Editar Registro",   submit: "Actualizar" },
                    remove: { button: "Eliminar", title: "Eliminar Registro", submit: "Eliminar", confirm: { _: "¿Seguro que desea eliminar estos %d registros?", 1: "¿Seguro que desea eliminar este registro?" } },
                    error:  { system: "Se ha producido un error, póngase en contacto con el administrador del sistema" }
                }
    	    });
	        ...
	        var table = $('#example').DataTable({
        		...
        		language: {
                    decimal:        "",
            		emptyTable:     "No tiene ninguna entrada con seguro para modificar",
    		    ...
    		    columns: [
    			    { 
    			        ...
    			        "render": function (val, type, row) {
                            return val == 2 ? "Granja Villa Sur" : val == 3 ? "Granja Villa Norte": val == 6 ? "Full Terror" : val == 11 ? "Terror": val == 13 ? "Noche de Espanto" : "Error en Entrada";
    			        }
                    },
            		{ data: "dateCartdetFreg"    },
            		{ data: "decCartdetStotal"   },
            		{ data: "varCartdetNombres"  },
            		{ data: "varCartdetApepat"   },
            		{ data: "varCartdetApemat"   },
            		{ data: "charCartdetDni"     },
            		{ data: "varCartdetTelefono" }
    		    ],
    		    select: true,
    		    scrollX: true,
    	    });
