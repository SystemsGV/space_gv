...
<div class="container module-opt"  id="content-mod-center">      
    <div class="row container">
      ...
      <? }?>
		<div class="col-md-3 no-padding">
	         	 <div class="caption text-center">
            <h3>Festival del Terror</h3><br>
          </div>      
        <div class="thumbnail" align="center">
                      
          <a data-toggle="modal" data-target="#TerrorModal"><img src="Adminv2/uploads/0962831001526570662.jpeg" style="border: 6px solid #5c8c00;"></a>
                  <div class="caption text-center">         
    ...
    <div class="modal-dialog">
        ...
        <div class="thumbnail" align="center">
          ...
          <a href="?mod=calendario&sel=11"><img src="Adminv2/uploads/0802145001526597460.jpeg" style="border: 6px solid #5c8c00;" class="opt11"></a>
                  <div class="caption text-center">         
