...
<div class="col-md-5 module-info">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <label>Precio: (Seleccione Fecha en el Calendario)</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 pull-right">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group spinner">
                          ...
                          <input type="text" class="form-control" name="txtcant" id="txtcant" value="1" min="1" max="20"  data-fv-notempty data-fv-notempty-message="Seleccione una cantidad">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <label>Fecha: (Seleccione Fecha en el Calendario)</label>
      ...
      <div class="col-md-7 module-info">        
        ...
        <div class="box-footer text-left" style="margin:10px 0px 13px 0px;" align="center">
