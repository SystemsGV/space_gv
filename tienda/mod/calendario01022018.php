  ...
  //$blockeddays = array("2016-08-02", "2016-08-08", "2016-08-10");
    ...
    foreach($endday as $date){
		...
		if(count($data_descuento)){
			$precio_boleto = $data_descuento[0]->descuento."                                                                <span style='color:#b4b4b4;'><strike>S/. ".$data_normal[0]->codigo."</strike></span>";
                    ...
                    <div class="col-sm-3 pull-right">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group spinner">
                          ...
                          <input type="text" class="form-control" name="txtcant" id="txtcant" value="1" min="1" max="09"  data-fv-notempty data-fv-notempty-message="Seleccione una cantidad">
