            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right"><h1>S/. <?=number_format($value["txtpu"], 2,'.','')?></h1></div>
                    </div>                    
                </div>
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="input-group"><span class="input-group-addon"><i class="fa fa-user"></i></span><input type="text" class="form-control input-sm"  name="regapepat-<?=$key?>" value="<?=$value["apepat"]?>" placeholder="Apellidos Paterno" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" data-fv-regexp="true"
                data-fv-regexp-regexp="^[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+$" data-fv-stringlength="true" data-fv-stringlength-min="2"/></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                            <label>Apellido Materno</label>
                            <div class="input-group"><span class="input-group-addon"><i class="fa fa-user"></i></span><input type="text" class="form-control input-sm"  name="regapemat-<?=$key?>" value="<?=$value["apemat"]?>" placeholder="Apellidos Materno" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" data-fv-regexp="true"
                data-fv-regexp-regexp="^[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+$" data-fv-stringlength="true" data-fv-stringlength-min="2"></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                            <label>Nombres</label>
                            <div class="input-group"><span class="input-group-addon"><i class="fa fa-user"></i></span><input type="text" class="form-control input-sm"  name="regname-<?=$key?>" value="<?=$value["nombres"]?>" placeholder="Nombres" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" data-fv-regexp="true"
                data-fv-regexp-regexp="^[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+$" data-fv-stringlength="true" data-fv-stringlength-min="2"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group"><span class="input-group-addon"><i class="fa fa-ticket"></i></span><input type="text" class="form-control input-sm"  name="regdni-<?=$key?>" value="<?=$value["dni"]?>" placeholder="DNI / Carne de Extranjeria" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" maxlength="15" data-fv-regexp-message="Porfavor ingrese un valor correcto."></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                            <label>Tel&eacute;fono</label>
                            <div class="input-group"><span class="input-group-addon"><i class="fa fa-phone"></i></span><input type="text" class="form-control input-sm"  name="regphone-<?=$key?>" value="<?=$value["telefono"]?>" placeholder="Telefono" data-fv-notempty data-fv-notempty-message="Este campo es obligatorio" data-fv-regexp="true"  data-fv-regexp-regexp="^[0-9_\.]+$" data-fv-regexp-message="Porfavor ingrese un valor correcto." data-fv-stringlength="true" data-fv-stringlength-min="6"></div>
                            </div>
                        </div>
                    </div>
                </div>
