...
<div class="container module-opt" id="content-mod-center">
    ...
    <div class="row container">
      ...
      <div class="col-md-7 module-info">        
        ...
        <div class="well well-sm" style="margin:10px 0px 20px 0px;">Por favor, seleccione el d&iacute;a que desea visitarnos en el calendario de abajo. Los precios que observa, son solo para compras online.</div>
        ...
        <p class="text-justify" align="justify" style="font-size:14px; "><strong><?=htmlspecialchars_decode(stripcslashes($post->txtmensaje))?></strong></p>
        ...
        <p class="text-justify" align="justify" style="font-size:14px;"><b>Seguro:</b> Por un pago adicional de S/. 5.00 por entrada, podrás cambiar la fecha de tu visita, si así lo deseas. Cabe recalcar, que la fecha solo podrá cambiarse a otro día con el mismo valor de entrada. De caso contrario, tendrás que depositar la diferencia. 
		...
		<p class="text-justify" align="justify" style="font-size:14px; color:red;"><b>* No se realiza devolución de dinero.</b></p>
		<p class="text-justify" align="justify" style="font-size:14px; color:red;"><b>* Los cambios de fecha no son válidos para días de exclusividad por eventos corporativos.</b></p>
		</p>
		</div>
        <p id="seguro4" class="text-justify" align="justify" style="font-size:14px; ">* Puede ingresar un máximo de 3 niños por adulto a la zona acuatica (piscinas). El ingreso es solo con pulsera mágica.</p>
