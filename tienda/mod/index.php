...
<div class="container module-opt"  id="content-mod-center">      
    <div class="row container">
      ...
      <?php } ?>
        ...
        <? }}?>
          <div class="caption text-center">         
            <a class="btn btn-danger" href="https://lagranjavilla.com/tiendaNew/?mod=calendario&sel=<?=$v->intboletoid?>" style="font-family: 'riffic_freebold', sans-serif; font-size:18px; letter-spacing: 1.5px;" role="button"><strong>COMPRAR ENTRADAS</strong></a>
          </div>
        </div>
      </div>
      <? }?>
