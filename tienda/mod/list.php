        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default widget">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-md-3">
								<?php if($value["seguro"]=='1'){ ?>
								<div class="form-group text-right"><h2>S/. <?=number_format(($value["txtpu"]-5), 2,'.',' ')?></h2></div>
				...
				if($_SESSION["sess_cart_sede"]["idsede"] == 1){
					$url='http://lagranjavilla.com/tienda/?mod=calendario&sel=2';
				}elseif($_SESSION["sess_cart_sede"]["idsede"] == 2){
					$url='http://lagranjavilla.com/tienda/?mod=calendario&sel=3';
				}elseif($_SESSION["sess_cart_sede"]["idsede"] == 6){
					$url='http://lagranjavilla.com/tienda/?mod=calendario&sel=6';
				}elseif($_SESSION["sess_cart_sede"]["idsede"] == 11){
					$url='http://lagranjavilla.com/tienda/?mod=calendario&sel=11';
				}elseif($_SESSION["sess_cart_sede"]["idsede"] == 13){
					$url='http://lagranjavilla.com/tienda/?mod=calendario&sel=13';
				}else{
					$url='http://lagranjavilla.com/tienda/';
				}
				?>
            </div>
            <div class="row">
				  ...
				  echo $url; 
				  ?>" 
				  class="btn btn-primary btn-block">Agregar más productos</a>
                  </div>
                  <div class="col-md-6">
