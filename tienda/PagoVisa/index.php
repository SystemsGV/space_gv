...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <h2 class="h font-weight-light"><b>PAGO CON VISA</b></h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <button type="button" class="btn btn-info" onclick="location='https://lagranjavilla.com/tiendaNew/?mod=form-2'">Regresar</button>
            </div>
        </div>
    </div>
    <!-- Optional JavaScript -->
