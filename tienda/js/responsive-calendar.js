...
(function() {
  ...
  (function($) {
      ...
      addOthers: function(day, dayEvents) {
        ...
        if (typeof dayEvents === "object") {
          if (dayEvents.number != null) {
            ...
            badge = $("<div></div>").html("S/. "+dayEvents.precio).addClass("badge");
            if (dayEvents.badgeClass != null) {
              badge.addClass(dayEvents.badgeClass);
            }
            //alert("day:"+day);
            day.append(badge.addClass("hidden-xs"));
            //day.html(badge)  
            //alert(day)
          }
          if (dayEvents.url) {
    ...
    $.fn.responsiveCalendar.defaults = {
      ...
      events: {
	  "2016-07-08": {"number": 5, "badgeClass": "badge-warning", "url": "http://www.lagranjavilla.com"}
	  },
      time: void 0,
      allRows: true,
