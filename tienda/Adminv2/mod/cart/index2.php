<?php
include 'serv.php';
$sql="select c.intClienteId, c.intCartSede, t.varSede from cart as c left join sede as t on c.intCartSede=t.intCartSede";
                  ...
                  <table id="example1" class="table table-bordered table-hover display" width="100%" data-page-length="25">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th width="11%">Nro Pedido</th> 
                         <th width="9%">Sede</th>                       
                        
                                             

                        <th width="13%">Comprador</th>                        

                        <th width="7%">Cant.</th>

                        <th width="7%">Total</th>

                        <th width="14%">C. Reserva</th>

                        <th width="13%">F. Registro</th>
