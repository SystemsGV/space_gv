...
if($_REQUEST["idf"]){
   ...
   $idOrder = $_REQUEST["idf"];
    ...
    $cc="sistemas@lagranjavilla.com, sistemas.st@lagranjavilla.com, atencionalcliente@lagranjavilla.com";	    
    ...
    foreach($det as $k=>$v){
		...
		*(No incluye el Bungy, ni los juegos feriales o de destre-za donde se concursa por un premio). Para m&aacute;s detalles de los juegos visita: 
		...
		1. Los participantes deben presentar DNI. La edad m&iacute;nima de ingreso al festival es de 8 a&ntilde;os (sin las atracciones extremas). Solo las personas mayores de 13 a&ntilde;os, pueden ingresar a las atracciones extremas.<br>
		...
		$terminosOther1 ='<table style="font-family:Arial; font-size:7px;" width="100%">
        <tr>
        <td width="50%" valign="top" style="font-family:Arial; font-size:7px;"><strong>BIENVENIDOS</strong> <br><br>
