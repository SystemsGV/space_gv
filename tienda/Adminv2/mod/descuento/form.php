...
<section class="content">
  <div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="row form-group">                                
          <div class="col-md-6">
            <label for="scliemail">Precio Descuento</label>
            <input type="text" class="form-control input-sm" name="descuento" id="descuento" placeholder="0.00" value="<?php echo $post->descuento; ?>">
          </div>
		  <div class="col-md-6">
            <label for="codigo">Precio Normal</label>
            <input type="text" class="form-control input-sm" name="codigo" id="codigo" placeholder="0.00" value="<?php echo $post->codigo; ?>">
          </div>
        </div>                 
    </div>
