    ...
    <div class="box-body">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        ...
                        <label for="pu">Precio Normal</label>

                        <input type="text" class="form-control input-sm" name="pu" id="pu" placeholder="Precio Normal" value="<?=$post->decboletopu?>">

                      </div>
                      <div class="col-md-4">

                        <label for="po">Oferta</label>

                        <input type="text" class="form-control input-sm" name="po" id="po" placeholder="Oferta" value="<?=$post->decboletopo?>">
