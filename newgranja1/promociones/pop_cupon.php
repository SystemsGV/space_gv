...
<p style="font-size:160%;">Nombre y Apellidos: <span style="font-size:160%;"><?=getVal("tbl_usuarios","txt_nombre","where id_usuarios='$_SESSION[session_socio]'")?></span> <span style="font-size:160%;"><?=getVal("tbl_usuarios","txt_apellido","where id_usuarios='$_SESSION[session_socio]'")?></span></p>
