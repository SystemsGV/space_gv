	...
	if (document.frm1.email.value!="")
	{
		   var txt=document.frm1.email.value;
			...
			if ((txt.indexOf(".com")<5)&&(txt.indexOf(".org")<5)
			   ...
			   &&(txt.indexOf(".com.pe")<5)&&(txt.indexOf(".es")<5)){
...
/*	if(/^\s+|\s+$/.test(document.frm1.nombres.value)) 
	...
	{
		alert("No Colocar Espacios en Blanco en el Usuario");
		document.frm1.user.focus();
		return;
	}
...
function bloquearEspacio(e, campo)
{
    ...
    <td width="553" valign="top">
        ...
        <td bgcolor="#EDE0C4">
            ...
            <td width="482">
                ...
                <tr>
                <td width="226" height="33" background="iconos/bg_campo.gif"><div class="form-group"><input class="cajatexto" style="width:196px;" type="text" name="user" id="user" maxlength="20" onkeypress="javascript: return bloquearEspacio();" required></div></td>
                <td width="30"></td>
