...
<!--               <a href="proc_cuponsel.php?idcp=<?=$rs["id_fotocupon"]?>">-->
                ...
                <div id="1" style="border:0px solid;overflow:auto;width:484px; height:415px"> 
                 ...
                 <a href="javascript:ventanaSecundaria('pop_cupon.php?idcp=<?=$rs["id_fotocupon"]?>')"> <img src="<?=UPLOAD_FOTOS_PUB.$img?>" style="background-image:url(iconos/bg_cupon_ver.png); padding: 10px 13px 47px 10px;" ></a>
