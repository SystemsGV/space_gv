<?php if($_GET[idf]){
  ...
  $post = Order::find($_GET[idf],array('select' => "*,DATE_FORMAT(datecartfreg, '%d/%m/%Y') freg,
                      ...
                      <div class="col-md-12">                        
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                              ...
                              $postdet = Orderdet::find_by_sql("select 

cd.intCartdetId,cd.charCartdetTipo, 
...
");
                              ...
                              foreach($postdet as $k=>$v){$i++;?>
                                ...
                                <tr>                                  
                                  ...
                                  <td align="right">S/.<?php echo number_format($v->deccartdetpu,2,".",""); ?></td>

                                    <td><?=$v->intcartdetcant?></td>

                                  <td align="right">S/.<?php echo number_format($v->deccartdetstotal,2,".",""); ?></td>
