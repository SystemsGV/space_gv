...

{
	...
	if (entrar)
	{   
		location.href="proc_categoria.php?op=3&id=" + id ;
	}
		...
		<table width="881" border="0" cellpadding="0" cellspacing="0" align="center">
			  <tr>
				<td width="881" height="4"><table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					<td height="30" bgcolor="#F1EEE7" class="titus">&nbsp;&nbsp;El CATALOGO - CATEGORIAS</td>
          ...
          <table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="372" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">Nombre de la Categoria</td>
			  <td width="105" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">Tipo</td>
              <td width="105" height="25" align="left" valign="middle" bgcolor="#DEDAC8" class="titus_tablas">Estado</td>
              <td width="135" valign="middle" bgcolor="#DEDAC8" class="titus_tablas" >Opciones</td>
            </tr>
			<tr>
...
//	echo "paginador->pos_final_pag : ".$paginador->pos_final_pag;
    while($contador < $paginador->pos_final_pag)
	{
			...
			if(!empty($registro[0]))
			{
				$sorteo= new cls_emp_categoria($registro[0]);
				if($color=="#F2F0EB")
				{
				  $color="#F6F5F5";}
				else{
  ...
  ?>
            <tr valign="middle" bgcolor="<? echo $color?>">
			  ...
			  <td align="left" bgcolor="<? echo $color?>" class="texto_02"><?=inc_devuelve_tipocat($sorteo->get_txt_cursofacultad())?></td>
              <td align="left" bgcolor="<? echo $color?>" class="texto_02"><?=inc_devuelve_estado($sorteo->get_int_estado())?></td>
              <td>
			  <a href="inf_categoria_det.php?id_detalle=<? echo $sorteo->get_id_categoria()?>"><img src="iconos/circulo_registros.gif" border="0" title="Agregar SubCategoria" /></a>&nbsp;&nbsp;
			  <a href="frm_categoria.php?modulo=<? echo $sorteo->get_id_categoria()?>"><img src="iconos/icon18_editdoc.gif" border="0" title="Editar registro" /></a>&nbsp;&nbsp; 
			  <a href="javascript:eliminar(<? echo $sorteo->get_id_categoria()?>)"><img src="iconos/delete.gif" border="0" title="Eliminar registro" /></a></td>
            </tr>
           <?
  		}
  	$contador++;
...
?>
                <td width="264" align="left"><a href="frm_categoria.php"><img src="iconos/ico_nuevo.gif" border="0" alt="Agregar nuevo"></a></td>
