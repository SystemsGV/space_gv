...
<html lang="es">
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top ">
  ...
  <div class="container cupon1">
    <p align="center" class="text-h1" style="background-color:  #0E7205; margin-bottom: 20px;">Imprime tus Cupones</p>
 ...
 <!-- CUPÓN NUMERO 1  -->
       <form action="" method="post">
         	<div class="tx_boddy3" id="first1">
      			<img src="<?=UPLOAD_CUPON.$img1?>" width="800" height="400"/>
      		</div>
       ...
       <br>
           <?php
           		if (isset($_POST['enviar1'])) {
           			...
           			$socio = $_POST['socio'];
           			$cupon = $_POST['cupon'];
           			$insertar = "INSERT INTO print_cupon(id_cliente, print) VALUES ('$socio', '$cupon')";
...
<!-- CUPÓN NUMERO 2  -->
          <form action="" method="post">
                <div class="tx_boddy3" id="first2">
                  <img src="<?=UPLOAD_CUPON.$img2?>" width="800" height="400"/>
                </div>
              <input type="hidden" name="socio" value="<?php echo $_SESSION['session_socio'];?>">
