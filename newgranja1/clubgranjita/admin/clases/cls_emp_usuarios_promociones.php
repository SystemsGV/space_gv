...
function cls_emp_usuarios($id=0)
{
	if($id!=0)
	{
		...
		$this->set_clientdni($fila['clientdni']);
	}else{
...
function set_clientdni($clientdni){	$this->clientdni=$clientdni;}
function get_clientdni(){	return $this->clientdni;	}

function guarda()
{
	$sql="insert into tbl_usuarios(txt_nombre, txt_apellido, txt_fecnac, txt_telefono, txt_direccion, txt_distrito, txt_email, txt_usuario, txt_password, id_opc, clientdni)"
		 ." values('".$this->get_txt_nombre()."', '".$this->get_txt_apellido()."', '".$this->get_txt_fecnac()."', '".$this->get_txt_telefono()."', '".$this->get_txt_direccion()."', '".$this->get_txt_distrito()."', '".$this->get_txt_email()."', '".$this->get_txt_usuario()."', '".$this->get_txt_password()."', '".$this->get_id_opc()."', '".$this->get_clientdni()."');";
	$id = conn_ejecuta($sql);
