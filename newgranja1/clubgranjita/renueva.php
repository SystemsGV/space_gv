          ...
          <div class="card">
            <div class="card-body">
             <img src="imgclub/socios.png" height="30" width="30" align="left" style="margin-right: 8px;" ><h6 class="textotitulo">    Renueva tu membresia</h6>
              <p class="add1">
              Para renovar su tarjeta de socios debes depositar* S/ 25.00 nuevos soles por cada carné a renovar.
              Tenemos las siguiente cuentas en soles a su disposición para efectuar el pago:
              Banco Continental
              Si recoge su carné de socio en la GRANJA VILLA SUR (CHORRILLOS) es : 0011-0130-0100046404-28 - BBVA
              Es importante recordar que toda renovación se realiza con 48 horas de anticipación de ser un depósito o transferencia, de esta manera podremos hacer las verificaciones correspondientes con el área contable.
              Luego de realizar el abono deberá ingresar la fecha de abono, el número de operación y enviar el voucher de pago escaneado al siguiente correo: clubgranjita@lagranjavilla.com
              (*)Para todos aquellos depósitos y/o transferencias realizados desde provincia por concepto de renovación de membresía el cliente deberá asumir los cargos adicionales que genere la transferencia a cuenta de LA GRANJA VILLA Y SU MUNDO MÁGICO S.A.
            </p><br>
