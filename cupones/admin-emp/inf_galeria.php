			...
			<table width="881" border="0" cellpadding="0" cellspacing="0" align="center">
			  <tr>
				...
				<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  <td width="43" height="32" valign="middle" bgcolor="#949494" class="titus_tablas" align="center">NRO</td>
					  <td width="395" align="left" valign="middle" bgcolor="#949494" class="titus_tablas">&nbsp;TITULO</td>
					  <td width="98" align="left" valign="middle" bgcolor="#949494" class="titus_tablas">&nbsp;ESTADO</td>
					  <td width="211" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">FOTO</div></td>
					  <td width="134" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">OPCIONES</div></td>
					</tr>
					<tr>
					...
					<td align="left" class="texto_02"><div style="padding-left:5px; padding-right:5px;"><?=nl2br(urldecode($noticia_tc->get_txt_titulo()));?></div></td>
					<td align="left" class="texto_02">&nbsp;<?=inc_devuelve_estado($noticia_tc->get_int_estado())?></td>
						  ...
						  ?>
					<td align="left" class="texto_02"><div align="center"><img src="<?=$foto?>" width="250" height="60" border="0" style="border:#333333 1px solid" /></div></td>
