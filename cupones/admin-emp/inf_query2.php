			  ...
			  <tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td width="849" height="30" class="titu_secc"> &nbsp;&nbsp;LISTADO DE FILES <?=$objcat->get_txt_nombre();?></td>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  <td width="80" height="32" valign="middle" bgcolor="#949494" class="titus_tablas" align="center">ID PAQ.</td>
                      <td width="150" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">FECHA VENTA</div></td>
					  <td width="300" align="left" valign="middle" bgcolor="#949494" class="titus_tablas">NOMBRE PASAJERO</td>	
                      <td width="300" align="left" valign="middle" bgcolor="#949494" class="titus_tablas">VENDIDO POR</td>					  
					  ...
					  <td width="120" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">ESTADO PAQ.</div></td>
					...
					/*	if($_POST['txt_cliente']!=""){$campo1="and txt_nombre like '%$_POST[txt_cliente]%'";}else{$campo1="";}
						...
						$sql="select id_cliente from tbl_cliente where id_categoria='{$_GET[idcat]}' and txt_nombre3 BETWEEN '$txt_criterio1' AND '$txt_criterio2' order by id_cliente desc";
