...
$cliente->set_txt_nombre2($_POST['nombres2']);
$cliente->set_txt_nombre3($_POST['nombres3']);
$cliente->set_txt_nombre4($_POST['nombres4']);
$cliente->set_txt_nombre5($_POST['nombres5']);
$cliente->set_txt_nombre6(addslashes($_POST['nombres6']));
$cliente->set_txt_nombre7(addslashes($_POST['nombres7']));
$cliente->set_txt_nombre8(addslashes($_POST['nombres8']));
$cliente->set_txt_direccion(addslashes($_POST['direccion']));
$cliente->set_txt_traslados($_POST['traslados']);
$cliente->set_txt_alojamiento($_POST['alojamiento']);
$cliente->set_txt_dias($_POST['dias']);
$cliente->set_txt_noches($_POST['noches']);
$cliente->set_txt_adicionales(addslashes($_POST['adicionales']));
$cliente->set_txt_telefono($_POST['telefono']);
$cliente->set_txt_celular(addslashes($_POST['celular']));
...
$cliente->set_txt_password($_POST['password']);
...
echo $_POST['nombres3'];*/
	...
	$hid_foto=$_POST['hid_txt_imagen'];
		...
		else
		{
			...
			$oResize->resizeWidthHeight("270", "100");
