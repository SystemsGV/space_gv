			  ...
			  <tr>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
                      ...
                      <? if($objcat0->getTipo()==1){?><a href="frm_consultas.php?idcat=<?=$idcat?>&id=<?=$cliente->get_id_cliente()?>"></a>&nbsp;&nbsp;&nbsp;&nbsp;<? if($objcat0->getTipo()==1){?><a href="frm_clientes.php?idcat=<?=$idcat?>&id=<?=$cliente->get_id_cliente()?>"><img src="iconos/ic_edit.png" border="0" alt="Editar registro" title="Editar registro" /></a><?}?><? if($objcat0->getTipo()==0){?><a href="frm_clientes.php?idcat=<?=$idcat?>&id=<?=$cliente->get_id_cliente()?>"><img src="iconos/ic_edit.png" border="0" alt="Editar registro" title="Editar registro" /></a><a href="javascript:eliminar(<?=$cliente->get_id_cliente()?>,<?=$idcat?>)"><img src="iconos/ic_delete.png" border="0" alt="Eliminar registro" title="Eliminar registro" /></a><?}?> </div></td>
					</tr>
                    <tr>
