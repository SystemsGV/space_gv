			  ...
			  <tr>
				<td width="100%" height="4"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					...
					<?
						$sql="select id_foto0 from tbl_hotel where id_cliente='$_GET[idcl]' order by id_foto0 DESC";
                    ...
                    <?
                      if($datos->get_int_stado()==1){
						$link="<a href='inf_fotos.php?idcat=1&idcl=".$cliente->get_id_cliente()."&id0=".$datos->get_id_foto0()."'>";
					...
					<td align="left"><div align="center"><a href="frm_reqpago.php?idcat=<?=$idcat?>&idcl=<?=$_GET[idcl]?>&id=<?=$datos->get_id_foto0()?>"><img src="iconos/ic_edit.png" border="0" alt="Editar registro" title="Editar registro" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:eliminar('<?=$datos->get_id_foto0()?>','<?=$foto?>','<?=$_GET['idcl']?>','<?=$idcat?>')"><img src="iconos/ic_delete.png" border="0" alt="Eliminar registro" title="Eliminar registro" /></a></div></td>
                    <tr>
