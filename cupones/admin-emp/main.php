...
<table bgcolor="#FFFFFF" width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <td width="100%">
			  ...
			  <tr>
                ...
                <td align="center" style="padding-top:20px; padding-bottom:20px;">
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="titu_secc11"><strong>BUSCAR POR NRO DE CUPON</strong></td>
                        </tr>
                        <tr>
                        <td height="15"></td>
                        </tr>
                ...
                <td width="50" class="titu_secc11" align="center">&oacute;</td>
                <td align="center" style="padding-top:20px; padding-bottom:20px;">
                	<table>
                    <tr>
                    <td width="80" align="center"><img src="iconos/ic_busca.png" alt="" border="0" /></td>
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                        <td class="titu_secc11"><strong>BUSCAR POR FECHA</strong></td>
                        </tr>
                        <tr>
                        <td height="15"></td>
                        </tr>
                        <!--<form action="inf_query2.php?idcat=1" method="post" name="form2" id="form1">-->
                        <form action="inf_query2.php?idcat=1" method="post" name="form2" id="form1">
                        <tr>
                        <td>
                        <table><tr><td><input name="txt_criterio1" id="txt_criterio1" class="textbox" style="width:200px; padding-left:9px; font-size:13px; " type="text" placeholder="Desde..." readonly /></td><td><input id="lanzador" type="image" src="calendario.png" />
				<script type="text/javascript">
					...
					button         :    "lanzador"   // el id del bot?n que lanzar? el calendario
                		...
                		<br>
                        <table><tr><td><input name="txt_criterio2" id="txt_criterio2" class="textbox" style="width:200px; padding-left:9px; font-size:13px; " type="text" placeholder="Hasta..." readonly /></td><td><input id="lanzador2" type="image" src="calendario.png" />
				<script type="text/javascript">
					Calendar.setup({
	...
	<tr>
	<td height="30" bgcolor="#b7b7b7">&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.lagranjavilla.com/" target="_blank" class="pie">La Granja Villa</a></td>
	</tr>
	</table>
