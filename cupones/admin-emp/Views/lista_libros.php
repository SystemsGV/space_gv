...
<body onload="lista_libros('');">
    ...
    <nav class="navbar navbar-default">
        <div class="navbar-header" width="100%"><center>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="width:1900px;">
           <?include("cabecera.php")?></table></center>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="col-xs-4  text-right">
                                    <label for="buscar" class="control-label">Buscar Empresa:</label>
                                </div>
                                <div class="col-xs-4">
                                    <input  type="text" name="buscar" id="buscar" class="form-control" onkeyup="lista_libros(this.value);" placeholder="Ingrese nombre de la empresa"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div id="lista"></div> 
