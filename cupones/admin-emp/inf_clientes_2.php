			  ...
			  <tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td height="30" class="titu_secc"> &nbsp;&nbsp;LISTADO DE FILES <?=$objcat->get_txt_nombre();?></td>
                    <td height="30" align="right"></td>
                    <td height="30" align="right"><a href="inf_clientes_2.php?idcat=1&char=1" class="myButton">FILES ABIERTOS</a>&nbsp;&nbsp;&nbsp;<a href="inf_clientes.php?idcat=1" class="myButton">TODOS LOS FILES</a></td>
				  </tr>
                  <tr>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  ...
					  <!--<td width="150" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">REGISTRO DE PAGOS</div></td>-->
					...
					<?
						...
						if($_GET['char']=="0") {		
						$sql="select id_cliente from tbl_cliente where id_categoria='{$_GET[idcat]}' and txt_telefono='{$_SESSION[session_administrator]}' order by id_cliente desc";
						}
						if($_GET['char']=="1") {		
						$sql="select id_cliente from tbl_cliente where id_categoria='{$_GET[idcat]}' and int_stado=0 and txt_telefono='{$_SESSION[session_administrator]}' order by id_cliente desc";
						}
					...
					<tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
					  ...
					  <!--<td align="left" class="texto_02"><div align="center"><a href="inf_fotos.php?idcat=1&idcl=<?=$cliente->get_id_cliente()?>"><img src="iconos/ic_video.png" border="0" alt="Editar Registro Pagos" /></a></div></td>-->
					...
					<tr>
					  <td width="80" height="32" valign="middle" bgcolor="#949494" class="titus_tablas" align="center"></td>
                      <td width="170" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center"></div></td>
					  <td width="260" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"></td>	
                      <td width="150" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center"></div></td>
                      <td width="260" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><!--TOTALES:--></td>
                      <td width="150" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><!--US$:&nbsp;<?=$total;?>--></td>
                      <td width="150" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><!--US$:&nbsp;<?=$comision;?>--></td>					  
                      
                      <td width="150" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center"></div></td>
					  <td width="150" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center"></div></td>
					  <!--<td width="150" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">REGISTRO DE PAGOS</div></td>-->
                      
					  <td width="120" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center"></div></td>
                      <td width="120" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center"></div></td>
					  <td width="191" align="center" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center"></div></td>
					</tr>
				  </table>
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					  <tr>
