...
function guarda()
{
	$sql="insert into tbl_cliente(id_categoria, txt_nombre, txt_nombre2, txt_nombre3, txt_nombre4, txt_nombre5, txt_nombre6, txt_nombre7, txt_nombre8, txt_direccion, txt_traslados, txt_alojamiento, txt_dias, txt_noches, txt_adicionales, txt_telefono, txt_celular, txt_email, txt_proyecto,txt_departamento, txt_usuario, txt_password, int_stado)"
		 ." values('".$this->get_id_categoria()."',
		  ...
		  $sql="insert into tbl_promocion(id_cliente, status_cupon, tipo_promo,fecha_venc)"
		  ." values('".$this->get_id_cliente()."',
		  '".$this->get_int_stado()."',
		  '".$this->get_txt_nombre7()."',
		  '".$this->get_txt_nombre4()."');";
...
function actualiza()
{
		...
		$sql="update tbl_promocion set id_cliente='".$this->get_id_cliente()."',"
		 ." status_cupon='".$this->get_int_stado()."',"
		 ." tipo_promo='".$this->get_txt_nombre7()."',"
		 ." fecha_venc='".$this->get_txt_nombre4()."'";
...
function elimina()
{
	...
	$sql="delete from tbl_promocion where id_cliente='".$this->get_id_cliente()."'";
