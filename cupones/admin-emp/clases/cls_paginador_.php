	...
	if($this->nro_paginas_pag>0)
	{
				...
				echo   "<tr>"; 
		  			...
		  			if($bloque_actual>1)
					{
						...
						$cad= "&nbsp;<a href='".$PHP_SELF."?pagina_pag=".$pagina_anterior_pag."&amp;bloque_actual_pag=".$prev."".$this->parametros_pag."&idcat=".$_GET["idcat"]."' target='_top' class='".$this->estilos_pag[1]."'>"; 						
				 ...
				 {				 
						  ...
						  else
						  {
							  if (empty($this->pagina_pag) && $i==1) 
							   ...
							   { echo "&nbsp;<a href='".$PHP_SELF."?pagina_pag=$i&amp;bloque_actual_pag=".$bloque_actual.$this->parametros_pag."&idcat=".$_GET["idcat"]."' target='_top' class='txt_gris10'>".$i."</a>&nbsp;"; }
						  }					  
				...
				echo	"     &nbsp;</td>";				
					...
					$cad="";
					$cad= "&nbsp;<a href='".$PHP_SELF."?pagina_pag=".$pagina_posterior_pag."&amp;bloque_actual_pag=".$next." ".$this->parametros_pag."' target='_top' class='".$this->estilos_pag[1]."&idcat=".$_GET["idcat"]."'>"; 						
