...
if(!empty($totalCupon)){
    for($i = 1; $i <=1; $i++){    
        ...
        <tr>
        <td width="60%" valign="top" style="font-family:Arial; font-size:7.5px;"><strong>&iexcl;BIENVENIDOS&#33;</strong><br />
        &iexcl;Estamos felices de que hayas elegido La Granja Villa para pasar tu d&iacute;a&#33; &iexcl;Nuestro objetivo es que vivas una experiencia 		
		entretenida y educativa al lado de tus seres queridos. Lee las siguientes indicaciones, por favor. te permitirán prepararte para el dia de tu visita:<br />
