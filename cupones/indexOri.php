                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <form method="POST" role="form" class="icon">
                                <div class="form-group">
                                    <div class="control">
                                        <input type="dni" id="dni" name="dni" class="form-control" placeholder="DNI">
                                        <i class="fa fa-user"></i>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="control">
                                        <input type="fecha" id="fecha" name="fecha" class="form-control" placeholder="Fecha de Nacimiento">
