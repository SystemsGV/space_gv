<?php
 $link =  mysql_connect("localhost","lagranja_cupon", "*g?N{enxyM*(") or die("<h2>No se encuentra Servidor</h2>");
       ...
       /* $resultado = mysql_query("SELECT f.id_categoria, f.txt_foto,f.txt_email,f.int_stado,f.int_retoque, cl.txt_nombre4 
        ...
        $resultado = mysql_query("SELECT f.id_categoria, f.txt_foto,f.txt_email,f.int_stado,f.int_retoque, cl.txt_nombre4, cl.txt_nombre6, ti.tipo_cupon, pro.tipo_promo, com.combos
                        from tbl_foto2 as f 
                        left join tbl_cliente as cl on f.id_cliente = cl.id_cliente
                        left join tbl_promocion as pro on f.id_cliente = pro.id_cliente
                        left join tbl_tipo as ti on cl.txt_nombre6 = ti.id
                        left join tbl_combos as com on pro.tipo_promo=com.id
                        WHERE f.int_retoque ='".$codigo."'", $link);
        $resultadoFinal = mysql_fetch_array($resultado);
...
<html lang="es">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="logo">
                        ...
                        <img src="../assets/img/logo.png" width="100" align="center">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">-->
              <!--<div class="page-content contact">-->
               ...
               <div class="register" style="width: 450px;" >
                    ...
                    <form class="form-group" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="buscarcupon" method="post">
        ...
        <table class="table table-responsive" width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <tr>
            ...
            <tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
                     ...
                     echo "<td>";
          					if($resultadoFinal['int_stado'] ==""){
            				echo '<span></span>';
         			 } else if ($resultadoFinal['int_stado']== 1){
        ...
        <tr>
            <tr>
                     ...
                     <td width="200" align="left" valign="middle" bgcolor="#262626" class="tablafront"><div class="titulobarra">TIPO</td>
                      <td width="200" align="left" valign="middle" bgcolor="#262626" class="tablafront"><div class="titulobarra">PROMOCION</td>                     
                      <td width="190" align="left" valign="middle" bgcolor="#262626" class="tablafront"><div class="titulobarra">DETALLE PROMOCION</td>
                      	<td width="190" align="left" valign="middle" bgcolor="#262626" class="tablafront"><div class="titulobarra">
            ...
            <tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
                     ...
                     <?php 
                     echo ("<td>" .$resultadoFinal["tipo_cupon"]."</td>"); 
                     echo ("<td>" .$resultadoFinal["tipo_promo"]."</td>"); 
					echo ("<td>" .$resultadoFinal["combos"]."</td>"); 
