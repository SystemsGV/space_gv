<?php
 $link =  mysql_connect("localhost","lagranja_cupon", "*g?N{enxyM*(") or die("<h2>No se encuentra Servidor</h2>");
       ...
       $codigo = $_POST["codigocupon"];
        ...
        $resultado = mysql_query("SELECT f.id_categoria, f.txt_foto,f.txt_email,f.int_stado, f.id_cliente, cl.txt_nombre4
                        from tbl_foto2 as f 
        ...
        <tr>
            <tr>
                     ...
                     <td width="304" align="left" valign="middle" bgcolor="#949494" class="titus_tablas">EMPRESA / CLIENTE</td>
                      <td width="304" align="center" valign="middle" bgcolor="#949494" class="titus_tablas">FECHA VENC</td>                     
                      <td width="190" align="center" valign="middle" bgcolor="#949494" class="titus_tablas">CODIGO DE CUPON</td>
                      <td width="226" align="center" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">STATUS</div></td>
            ...
            <tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
                     ...
                     /*echo ("<td>" .if($resultadoFinal["int_stado"]==1) {
                         echo "cupon usado";
                     } else {
                         echo "cupon vigente";
                     }."</td>"); */
