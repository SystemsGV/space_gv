<?
	...
	$combos =mysqli_query($con, "select * from tbl_combos" );
     ...
     <!--     /*     <tr bgcolor="#f5f5f5">
              ...
              <tr bgcolor="#f5f5f5">
                ...
                <td align="left" bgcolor="#f5f5f5" placeholder="Colocar Promoción">&nbsp;&nbsp;<select name="nombres7" class="input" >
                    ...
                    <option value="<?php echo $p['id']; ?>"><?php echo $p['combos']; ?></option>
                                      <?php endforeach; ?>
                    
                 <!-- <option value="1" <?php /*?><? if($socio->get_txt_nombre7()=='1'){ echo "selected"; }?> ><? echo 'Pulsera + corn + algodon';?><?php */?></option>
					<option value="2" <?php /*?><? if($socio->get_txt_nombre7()=='2'){ echo "selected"; }?> ><? echo 'Pulsera + 1/4 Pollo + Chicha';?><?php */?></option>
					<option value="3" <?php /*?><? if($socio->get_txt_nombre7()=='3'){ echo "selected"; }?> ><? echo 'Pulsera + 1/4 Pollo + Gaseosa';?><?php */?></option>
					<option value="4" <?php /*?><? if($socio->get_txt_nombre7()=='4'){ echo "selected"; }?> ><? echo 'Pulsera de Cortesia';?<?php */?>></option>-->
