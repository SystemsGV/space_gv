	...
	<td>
		...
		<td width="100%" height="4"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td height="30" align="right" valign="bottom"><a href="inf_hotel.php?idcat=<?=$idcat?>&idcl=<?=$_GET['idcl'];?>" class="myButton4">< REGRESAR</a></td>
		  </tr>
		  <tr>
			<td height="10"></td>
		  </tr>
          ...
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
              ...
              <tr bgcolor="#f5f5f5">
                ...
                <td>:</td>
                <td align="left" bgcolor="#f5f5f5"><input name="txt_titulo5" type="text" class="input" size="20" value="<?=urldecode($dato->get_txt_titulo5())?>" /></td>
              </tr>		  	
              <tr bgcolor="#f5f5f5">
                <td colspan="3" height="15"></td>
              </tr>
