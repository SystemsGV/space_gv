			  ...
			  <tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td width="205" align="right"><button type="submit" class="myButton2" name="display" id="display">ACTUALIZAR REGISTRO</button></td>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
					  ...
					  <?if($cliente->get_txt_nombre6()==10){?>
					  <td align="center" class="tipo"><b>Promo dos sedes</b></td>
