...
function eliminar(idcat)
{
	...
	if (entrar)
	{   
		location.href="proc_categoria.php?op=3&idcat="+idcat;
	}
}
</script>
</head>
			  ...
			  <tr>
                ...
                <table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td width="849" height="30" class="titu_secc"> &nbsp;&nbsp;Nacionales: Categorias</td>
				  </tr>
                  <tr>
				...
				<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  ...
					  <td width="450" align="left" valign="middle" bgcolor="#949494" class="titus_tablas">NOMBRE DE LA CATEGORIA</td>					  
					  <td width="117" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">ZONA</div></td>
					  <td width="109" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">PAQUETES</div></td>
					  <td width="26" align="left" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center"></div></td>
					  <td width="127" align="center" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">OPCIONES</div></td>
					</tr>
					<tr>
					  <td colspan="6" height="2"></td>
				    </tr>
					<?
						$sql="select id_categoria from tbl_categoria order by int_zona, txt_nombre";
					...
					<tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
					  ...
					  <td align="left" class="texto_02"><div style="font-size:14px;"><b><?=$cliente->get_txt_nombre()?></b></div></td>
					  <td class="texto_02" align="center">
                      <?
                      if($cliente->get_int_zona()==1){
					  echo "NORTE";
					  }
					  if($cliente->get_int_zona()==2){
					  echo "CENTRO";
					  }
					  if($cliente->get_int_zona()==3){
					  echo "SUR";
					  }
					  ?>
                      </td>
					  <td align="left" class="texto_02"><div align="center"><a href="inf_clientes.php?idcat=<?=$cliente->get_id_categoria()?>"><img src="iconos/ic_addart.png" border="0" alt="Administrar articulos" title="Administrar paquetes" /></a></div></td>
					  <td align="left" class="texto_02">&nbsp;</td>
					  <td align="center"><div align="center"><a href="frm_categoria.php?idcat=<?=$cliente->get_id_categoria()?>"><img src="iconos/ic_edit.png" border="0" alt="Editar registro" title="Editar registro" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:eliminar(<?=$cliente->get_id_categoria()?>)"><img src="iconos/ic_delete.png" border="0" alt="Eliminar registro" title="Eliminar registro" /></a> </div></td>
					</tr>
                    <tr>
					...
					<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						<td width="205" align="left"><a href="frm_categoria.php"><img src="iconos/ico_nuevo.gif" border="0" alt="Agregar nuevo"></a></td>
