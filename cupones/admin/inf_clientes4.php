			  ...
			  <tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
                    ...
                    <form name="form1" method="post" action="inf_clientes4.php?idcat=1" id="cdr">
                    <h2>Buscar Empresa</h2>
                    <input  type="text" name="buscar" id="buscar" class="form-control" onKeyUp="lista_libros(this.value);" placeholder="Ingrese la empresa"/>
					...
					if($busca!=""){
						...
						$busqueda=mysql_query("select * from tbl_cliente whare txt_nombre like '%".$busca."%'");
					}
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  <td width="304" height="32" valign="middle" bgcolor="#949494" class="titus_tablas" align="center">NRO</td>
					  <td width="504" align="left" valign="middle" bgcolor="#949494" class="titus_tablas">EMPRESA / CLIENTE</td>	                
					  ...
					  <? if(($objcat0->getTipo()==0) || ($objcat0->getTipo()==1)){?> <td width="401" align="center" valign="middle" bgcolor="#949494" class="titus_tablas"><div align="center">OPCIONES</div></td><?}?>
					</tr>
					<tr>
					...
					<tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
                     ...
                     <? if($objcat0->getTipo()==1){?><a href="frm_clientes.php?idcat=<?=$idcat?>&id=<?=$cliente->get_id_cliente()?>"><img src="iconos/ic_edit.png" border="0" alt="Editar registro" title="Editar registro" /></a><?}?><? if($objcat0->getTipo()==0){?><a href="frm_clientes.php?idcat=<?=$idcat?>&id=<?=$cliente->get_id_cliente()?>"><img src="iconos/ic_edit.png" border="0" alt="Editar registro" title="Editar registro" /></a><a href="javascript:eliminar(<?=$cliente->get_id_cliente()?>,<?=$idcat?>)"><img src="iconos/ic_delete.png" border="0" alt="Eliminar registro" title="Eliminar registro" /></a><?}?> </div></td>
					</tr>
                    <tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
                        ...
                        <? if($objcat0->getTipo()==1){?><a href="frm_clientes.php?idcat=<?=$idcat?>&id=<?=$cliente->get_id_cliente()?>"><img src="iconos/agregarregistro.png" border="0" alt="Agregar Registro" title="Agregar Registro" /></a><?}?><? if($objcat0->getTipo()==0){?><a href="frm_clientes.php?idcat=<?=$idcat?>&id=<?=$cliente->get_id_cliente()?>"><img src="iconos/agregarregistro.png" border="0" alt="Agregar Registro" title="Agregar Registro" /></a><a href="javascript:eliminar(<?=$cliente->get_id_cliente()?>,<?=$idcat?>)"></a><?}?>
                        </td>
