  ...
  <td width="100%">
	...
	<td>
             ...
             <tr bgcolor="#ffffff">
              ...
              <tr bgcolor="#f5f5f5">
                ...
                <td align="left" bgcolor="#f5f5f5">&nbsp;&nbsp;<select name="nombres6" class="input">
                    ...
                    <option value="9" <? if($socio->get_txt_nombre6()=='9'){ echo "selected"; }?> ><? echo 'Compras';?></option>
					<option value="10" <? if($socio->get_txt_nombre6()=='10'){ echo "selected"; }?> ><? echo 'Promo dos sedes';?></option>
                  </select>                </td>
              </tr> 
              <tr bgcolor="#f5f5f5">
                <td height="15"></td>
     ...
     <!--     /*     <tr bgcolor="#f5f5f5">
              ...
              <tr bgcolor="#f5f5f5">
                <td height="15" align="right" class="texto_campos">TIPO DE PROMOCION:</td>
                <td align="left" bgcolor="#f5f5f5" placeholder="Colocar Promoción">&nbsp;&nbsp;<select name="nombres7" class="input" >
                    <option value="">Seleccionar Promocion</option>
                    <option value="1" <? if($socio->get_txt_nombre7()=='1'){ echo "selected"; }?> ><? echo 'Pulsera + corn + algodon';?></option>
					<option value="2" <? if($socio->get_txt_nombre7()=='2'){ echo "selected"; }?> ><? echo 'Pulsera + 1/4 Pollo + Chicha';?></option>
					<option value="3" <? if($socio->get_txt_nombre7()=='3'){ echo "selected"; }?> ><? echo 'Pulsera + 1/4 Pollo + Gaseosa';?></option>
					<option value="4" <? if($socio->get_txt_nombre7()=='4'){ echo "selected"; }?> ><? echo 'Pulsera de Cortesia';?></option>
					<option value="5" <? if($socio->get_txt_nombre7()=='5'){ echo "selected"; }?> ><? echo 'Promo Corp. 6x5';?></option>
					<option value="6" <? if($socio->get_txt_nombre7()=='6'){ echo "selected"; }?> ><? echo 'Promo Corp. 5x4';?></option>
					<option value="7" <? if($socio->get_txt_nombre7()=='7'){ echo "selected"; }?> ><? echo 'Promo Corp. 4x3';?></option>
					<option value="8" <? if($socio->get_txt_nombre7()=='8'){ echo "selected"; }?> ><? echo 'Brazalete + 1/4 Pollo c/papas fritas + 2 chichas + Churro + PopCorn';?></option>
					<option value="9" <? if($socio->get_txt_nombre7()=='9'){ echo "selected"; }?> ><? echo 'Pollo Entero + Ensalada + papas fritas + 4 chichas';?></option>
					<option value="10" <? if($socio->get_txt_nombre7()=='10'){ echo "selected"; }?> ><? echo 'Pulsera+ Hamburguesa C/ Papas al hilo+ Chicha';?></option>
