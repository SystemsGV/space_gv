...
$chkCat = join(" ",$_POST['rckcat']);
$cliente = new cls_emp_cliente();
$cliente->set_id_cliente($id);
$cliente->set_id_categoria($chkCat);
...
////////////////////////////////////////////// Foto Chica //////////////////////////////////////////////
	...
	$hid_foto=$_POST['hid_txt_imagen'];
		...
		{
			$archivo = inc_cargar_datos("txt_imagen",UPLOAD_FOTOS,"proc_clientes2.php",$extensiones_imagenes);						
			$oResize = new ImageResize(UPLOAD_FOTOS.$archivo);
			$oResize->resizeWidthHeight("168", "190");
...
if(($op==1) || ($op==2) || ($op==3))
{
	header ("location: inf_clientes2.php?idcat=".$idcat); 
}else{
