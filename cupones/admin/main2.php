			  ...
			  <tr>
                ...
                <td align="center" style="padding-top:20px; padding-bottom:20px;">
                    ...
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                        <td class="titu_secc11"><strong>REPORTE VENTAS POR AGENTE</strong></td>
                        </tr>
                        <tr>
                        <td height="15"></td>
                        </tr>
                        <form action="inf_query0.php?idcat=1" method="post" name="form2" id="form1">
                        <tr>
                        <td>
                        <? if($objcat0->getTipo()==0){
						$sql="select * from administrador where tipo=1 order by nombres asc";				
						cboComplejo("txt_criterio","textbox",$sql,"id_administrador","nombres",$objcat0->getId_administrador(),"txt_criterio",0,1);
						echo "<br><br>";
					    } else { ?>
						<input name="txt_criterio" id="txt_criterio" class="textbox" style="width:1px; visibility:hidden" value="<?=$_SESSION['session_administrator']?>" type="text" />
                        <? } ?>                    
