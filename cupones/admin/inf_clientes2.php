			  ...
			  <tr>
				...
				<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<?
						...
						$sql="select id_cliente from tbl_cliente2 where MATCH(id_categoria) AGAINST('{$idcats}' IN BOOLEAN MODE)";						
					...
					<tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
					  ...
					  <td align="center"><div align="center"><a href="frm_clientes2.php?idcat=<?=$idcat?>&id=<?=$cliente->get_id_cliente()?>"><img src="iconos/ic_edit.png" border="0" alt="Editar registro" title="Editar registro" /></a>&nbsp;&nbsp;<a href="http://www.riostore.pe/fbpreordenes.php?id=<?=$cliente->get_id_cliente()?>" target="_blank"><img src="iconos/ic_face.png" border="0" alt="Compartir en Facebook" title="Compartir en Facebook" /></a>&nbsp;&nbsp;<a href="javascript:eliminar(<?=$cliente->get_id_cliente()?>,<?=$idcat?>)"><img src="iconos/ic_delete.png" border="0" alt="Eliminar registro" title="Eliminar registro" /></a> </div></td>
