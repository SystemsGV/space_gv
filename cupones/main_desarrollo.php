    ...
    <section class="container section-lg" style="margin-top:0px; padding-top:40px;">
        <div class="row">  
            <div class="col-md-6 col-sm-5">
                ...
                <button action="admin/reportecliente.php" id="reportecliente" type="button" class="btn btn-primary"><i class="fa fa-paper-plane-o"></i>Ver Generados</button>
            </div>
			...
			<div class="col-md-6 col-sm-7">
                ...
                <form class="form-horizontal" onSubmit="return validarForm();" role="form" id="ajax-contact" method="post" action="assets/php/mailer.php">
                    ...
                    <div class="form-group icon">
						...
						<?}else{?>
							<button id="btnCupon" type="button" class="btn btn-primary"><i class="fa fa-paper-plane-o"></i>Generar Cupones</button>
						<?}?>
                        </div>
                        <div class="col-sm-3">
