			  ...
			  <tr>
                ...
                <table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td width="849" height="30" class="titu_secc"> &nbsp;&nbsp;STOCK: CATEGORIAS</td>
				  </tr>
                  <tr>
				...
				<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<?
						$sql="select id_categoria from tbl_categoria order by txt_nombre";
					...
					<tr valign="middle" bgcolor="<?=$color?>" class="bg_fila">
					  ...
					  <td align="left" class="texto_02"><div align="center"><a href="inf_clientes.php?idcat=<?=$cliente->get_id_categoria()?>"><img src="iconos/ic_addart.png" border="0" alt="Administrar articulos" title="Administrar articulos" /></a></div></td>
					  <td align="left" class="texto_02">&nbsp;</td>
