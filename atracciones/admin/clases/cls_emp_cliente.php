...
function cls_emp_cliente($id=0)
{
	if($id!=0)
	{
		...
		$this->set_txt_email2($fila['txt_email2']);
		...
		$this->set_txt_usuario2($fila['txt_usuario2']);
...
function set_txt_email2($txt_email2){	$this->txt_email2=$txt_email2;}
function get_txt_email2(){	return $this->txt_email2;	} 
...
function set_txt_usuario2($txt_usuario2){	$this->txt_usuario2=$txt_usuario2;}
function get_txt_usuario2(){	return $this->txt_usuario2;	} 
...
function guarda()
{
	$sql="insert into tbl_cliente(id_categoria, txt_nombre, txt_direccion, txt_telefono, txt_celular, txt_email, txt_email2, txt_proyecto,txt_departamento, txt_usuario, txt_usuario2, txt_password, int_stado)"
		 ." values('".$this->get_id_categoria()."', '".$this->get_txt_nombre()."', '".$this->get_txt_direccion()."', '".$this->get_txt_telefono()."', '".$this->get_txt_celular()."', '".$this->get_txt_email()."', '".$this->get_txt_email2()."', '".$this->get_txt_proyecto()."', '".$this->get_txt_departamento()."', '".$this->get_txt_usuario()."', '".$this->get_txt_usuario2()."', '".$this->get_txt_password()."', '".$this->get_int_stado()."');";
	$id = conn_ejecuta($sql);
...
function actualiza()
{
		$sql="update tbl_cliente set txt_nombre='".$this->get_txt_nombre()."', "
