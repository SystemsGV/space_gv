...
function cls_administrador($id=0)
{
	if($id!=0)
	{
		$sql="select id_administrador,nombres,correo, clave as clave,usuario from administrador where id_administrador='".$id."' order by id_administrador";
...
function guarda()
{
	$sql="insert into administrador(nombres,correo,usuario,clave)"
