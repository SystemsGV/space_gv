			  ...
			  <tr>
				<td width="881" height="4"><table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					...
					<td height="30"><table width="100%" class="titu_secc"><tr><td align="left">&nbsp;IMAGENES - <?=strtoupper($cliente->get_txt_nombre())?></td><td align="right"><a href="inf_clientes2.php?idcat=<?=$idcat?>" ><img src="iconos/volver.gif" alt="Volver" border="0"></a></td></tr></table></td>
				  </tr>
				  <tr>
					...
					<td align="left"><div align="center"><a href="frm_fotos2.php?idcat=<?=$idcat?>&idcl=<?=$_GET[idcl]?>&id=<?=$datos->get_id_foto()?>"><img src="iconos/ic_edit.png" border="0" alt="Editar registro" title="Editar registro" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:eliminar('<?=$datos->get_id_foto()?>','<?=$foto?>','<?=$_GET['idcl']?>','<?=$idcat?>')"><img src="iconos/ic_delete.png" border="0" alt="Eliminar registro" title="Eliminar registro" /></a></div></td>
                    <tr>
					...
					<table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td width="205" align="left"><a href="frm_fotos2.php?idcat=<?=$idcat?>&idcl=<?=$_GET[idcl]?>"><img src="iconos/ico_nuevo.gif" border="0" alt="Agregar nuevo"></a></td>
