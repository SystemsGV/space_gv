		...
		<td width="881" height="4"><table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr bgcolor="#989898">
              ...
              <tr bgcolor="#f5f5f5">
                <td height="26" align="right" class="texto_campos">URL de destino</td>
                <td>:</td>
              ...
              <tr bgcolor="#f5f5f5">
                ...
                <td align="left" bgcolor="#f5f5f5"><table width="255" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="135"><img src="<? echo UPLOAD_GALERIA.$noticia_tc->get_txt_foto()?>" width="240" height="120" style="border:#FFFFFF 1px solid" /></td>
