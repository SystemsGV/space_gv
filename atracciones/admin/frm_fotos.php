...
// Valida para la foto 1
   if(document.form1.txt_imagen.value!="" && i==0)
	...
	if(i==0){
		document.form1.action="proc_foto.php?op=1&idcat="+idcat;
...
// Valida para la foto 1
   if(document.form1.txt_imagen.value!="" && i==0)
	...
	if(i==0){
		document.form1.action="proc_foto.php?op=2&id="+id+"&idcat="+idcat;
		document.form1.submit();
	}
}
	...
	<td>
		...
		<td width="881" height="4"><table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td height="30" align="right" valign="bottom"><a href="inf_fotos.php?idcat=<?=$idcat?>&idcl=<?=$_GET['idcl'];?>"><img src="iconos/volver.gif" alt="Volver" border="0"></a></td>
		  </tr>
		  <tr>
			<td height="10"></td>
		  </tr>
