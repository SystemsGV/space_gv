<?
	...
	include("clases/cls_emp_descripcion2.php");
...
function registrar()
{
	...
	if(i==0){
		document.form1.action="proc_descripcion2.php?op=1";
...
function editar(id)
{
	...
	if(i==0){
		document.form1.action="proc_descripcion2.php?op=2&id="+id ;
		document.form1.submit();
	}
}
	...
	<td>
		...
		<td width="881" height="4"><table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td height="30" align="right" valign="bottom"><a href="inf_clientes2.php"><img src="iconos/volver.gif" alt="Volver" border="0"></a></td>
		  </tr>
		  <tr>
			<td height="10"></td>
		  </tr>
          ...
          <table width="881" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr bgcolor="#989898">
              ...
              <tr bgcolor="#f5f5f5">
                <td height="26" align="right" class="texto_campos" valign="top">Descripción del Servicio:</td>
