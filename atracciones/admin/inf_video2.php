...

{
	...
	if (entrar)
	{   
		location.href="proc_video2.php?op=3&idcl="+idcl+"&id="+id+"&idcat="+idcat;
	}
...
<td width="908">
	...
	<td>		
		...
		<td width="881" height="4">
			...
			<td height="30" align="right" valign="bottom"><a href="inf_clientes2.php?idcat=<?=$idcat?>"><img src="iconos/volver.gif" alt="Volver" border="0"></a></td>
			</tr>
			<tr>
            ...
            <?
	$sql="select * from tbl_video2 where id_cliente=".$_GET['idcl'];
  ...
  ?>
            ...
            <td align="center"><a href="frm_video2.php?id=<?=$sorteo->get_id_video()?>&idcl=<?=$_GET['idcl']?>&idcat=<?=$idcat?>"><img src="iconos/ic_edit.png" border="0" title="Editar registro" /></a>&nbsp;&nbsp;<a href="javascript:eliminar('<?=$sorteo->get_id_video()?>','<?=$_GET['idcl']?>','<?=$idcat?>')"><img src="iconos/ic_delete.png" border="0" title="Eliminar registro" /></a></td>
            </tr>
            <tr>
...
?>
            <td width="264" align="left"><a href="frm_video2.php?idcat=<?=$idcat?>&idcl=<?=$_GET['idcl']?>"><img src="iconos/ico_nuevo.gif" border="0" alt="Agregar nuevo"></a></td>
